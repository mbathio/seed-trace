        ...
        <div className="container mx-auto px-4 py-8 md:py-16">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <a href="#fonctionnalites">
                  <Button
                    variant="outline"
                    className="border-white text-white hover:bg-isra-green-dark w-full sm:w-auto"
                  >
                    En savoir plus
                  </Button>
                </a>
            ...
            <div className="lg:w-1/2">
              <img
                src="/isra-logo.png"
                alt="Logo ISRA - Institut Sénégalais de Recherches Agricoles"
                className="w-full max-w-md mx-auto rounded-lg shadow-lg bg-white p-4"
              />
            </div>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                L'ISRA est l'un des deux seuls établissements au Sénégal
                produisant des semences de niveaux GO, G1, G2 et G3,
                essentielles pour la filière semencière nationale.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <CardContent className="p-6 text-center">
                  <div className="bg-isra-green-light rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                    <svg
                      ...
                      className="h-8 w-8 text-isra-green"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <p className="text-gray-600">
                    Traçabilité complète de chaque lot de semences, de la
                    production à la distribution aux multiplicateurs.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  <div className="bg-isra-brown-light rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-8 w-8 text-isra-brown"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <p className="text-gray-600">
                    Contrôles qualité à chaque étape pour garantir
                    l'authenticité et la performance des semences.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    Statistiques et rapports détaillés pour orienter les
                    politiques semencières nationales.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <section id="fonctionnalites" className="py-12 md:py-20 bg-gray-100">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                Une solution complète pour le suivi des semences à tous les
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  Créez et suivez des lots de semences avec leurs
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  Générez des codes QR uniques pour chaque lot facilitant
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  Visualisez l'arbre généalogique complet de chaque lot de
                  semences.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  Enregistrez les tests de qualité et validez les lots conformes
                  aux standards.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  Suivez les parcelles de production avec leurs caractéristiques
                  et historiques.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  Générez des rapports détaillés sur la production et la
          ...
          <div className="container mx-auto px-4">
            <div className="bg-isra-green-light bg-opacity-20 rounded-xl p-8 lg:p-12 text-center">
              ...
              <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
                Connectez-vous au système de traçabilité des semences pour
                assurer un suivi optimal de votre production semencière.
              </p>
              <Link to="/login">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              <Link to="/" className="hover:text-isra-green-light">
                Accueil
              </Link>
              <Link to="/login" className="hover:text-isra-green-light">
                Connexion
              </Link>
              <a href="#" className="hover:text-isra-green-light">
                Contact
              </a>
            </div>
          </div>
          <div className="mt-8 text-center text-sm text-gray-400">
            &copy; {new Date().getFullYear()} ISRA Saint-Louis. Tous droits
            réservés.
          </div>
        </div>
      </footer>
