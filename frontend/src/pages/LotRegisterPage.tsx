    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex pt-16">
        ...
        <main className="flex-1 ml-0 md:ml-64 p-6">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-isra-green-dark">Enregistrement d'un Lot</h1>
            <p className="text-gray-500">Créez un nouveau lot de semences dans le système</p>
          </div>
